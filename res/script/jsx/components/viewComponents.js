...
function ControlButton(props) {
    if (props.id) {
        return React.createElement(
            'div',
            { className: "newButton", id: props.id, onClick: function onClick() {
                    props.fun();
                } },
            React.createElement(
                'span',
                { className: "nB_left", style: { borderBottom: '3px solid ' + props.color } },
                props.simpleName
            ),
            React.createElement(
                'span',
    ...
    return React.createElement(
        'div',
        { className: "newButton", onClick: function onClick() {
                props.fun();
            } },
        React.createElement(
            'span',
